  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['BE25', 'Bi8', 'Bi9', 'Ch21a', 'Ch21b', 'Ch21c', 'Ch41a', 'Ch41b', 'Ch41c', 'Ph2a', 'Ph2b', 'Ph2c', 'Ph12a', 'Ph12b', 'Ph12c'],
        minUnits: 18,
      },
      {
        id: 'cs-adv',
        ...
        courses: ['CS124', 'CMS_CS_IDS139', 'CS_EE_IDS143', 'CMS_CS_Ec_EE144', 'CS_IDS150a', 'CS151', 'CS115', 'CS116', 'CS121', 'CS128', 'CS130', 'CS131', 'CS132', 'CS152', 'CMS_CS_CNS_EE_IDS155', 'CS164', 'EECNSS148a', 'EECNSS148b', 'CS_CNS171', 'IDS_ACM_CS157', 'IDS_ACM_CS158'],
        minUnits: 72,
      },
      {
        id: 'cs-thesis',
    ...
    requirements: [
      {
        ...
        courses: ['EE10a', 'EE10b', 'EEAPh40', 'EE44', 'EE45', 'EE55'],
        minCourses: 4,
      },
      {
        id: 'ee-signals',
      ...
      },
      {
        ...
        courses: ['Ma2', 'ACM95a', 'ACM95b', 'ACM104', 'ACM116'],
        minCourses: 3,
      },
      {
        id: 'ee-physics',
      ...
      },
      {
        ...
        courses: ['EE111', 'EE112', 'EE120', 'EE151', 'EECSIDs160', 'EEMA_CS127', 'EE_CNS_CS148a', 'CS_EE_IDS143', 'MECSEE133a', 'MECSEE133b', 'APh105', 'APh110', 'APhMSME105a', 'APhMSME105b'],
        minUnits: 72,
      },
    ],
  },
    ...
    requirements: [
      {
        ...
        courses: ['AeAPh101a', 'AeAPh101b', 'AeAPh101c'],
        minCourses: 3,
      },
      {
        id: 'me-structures',
        ...
        courses: ['AeAM102a', 'AeAM102b', 'AeAM102c'],
        minCourses: 3,
      },
      {
        id: 'me-thermo',
      ...
      },
      {
        ...
        courses: ['Ma2', 'ACM95a', 'ACM95b', 'Ma3', 'MaCS6a', 'ACM104'],
        minCourses: 3,
      },
      {
        id: 'me-physics',
      ...
      },
      {
        ...
        courses: ['ME129', 'MECSEE133a', 'MECSEE133b', 'MECSEE134', 'MECSEE169', 'APhMSME105a', 'APhMSME105b', 'CDS110', 'ME118'],
        minUnits: 45,
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['ACM116', 'ACM118', 'MaACMIDS140a'],
        minCourses: 1,
      },
      {
        id: 'acm-math',
      ...
      },
      {
        ...
        courses: ['ACM95a', 'ACM95b', 'ACM95c', 'ACM104', 'ACM106a', 'ACM106b', 'ACM116', 'ACM118', 'ACM101a', 'ACM101b', 'Ma108a', 'Ma108b', 'Ma108c', 'Ma121a', 'MaACMIDS140a'],
        minUnits: 27,
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['Ec105', 'Ec106', 'Ec110', 'Ec121a', 'Ec121b', 'Ec122', 'PsEc172', 'BEM102', 'BEM103', 'BEM120'],
        minUnits: 45,
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['BEM104', 'BEM106', 'BEM109', 'BEM114', 'BEM120'],
        minCourses: 3,
      },
      {
        id: 'bem-elec',
        ...
        courses: ['BEM102', 'BEM103', 'BEM104', 'BEM106', 'BEM109', 'BEM114', 'BEM120', 'Ec105', 'Ec106', 'Ec110', 'Ec121a', 'Ec122', 'PsEc172'],
        minUnits: 45,
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['APh9', 'APhEE23', 'Ph3', 'Ph5', 'Ph6', 'Ph7'],
        minCourses: 2,
      },
      {
        id: 'aph-states',
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['Ma2', 'Ma3', 'ACM104', 'ACM95a', 'ACM95b'],
        minCourses: 3,
      },
      {
        id: 'ms-adv',
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['ACM95a', 'ACM95b', 'ACM104', 'ACM116', 'MaACMIDS140a'],
        minCourses: 3,
      },
      {
        id: 'cns-cs',
      ...
      },
      {
        ...
        courses: ['CMS_CS_CNS_EE_IDS155_CNS', 'CS_CNS_EE156a', 'CS_CNS_EE156b', 'EECNSS148a', 'CNS100', 'CNS102'],
        minCourses: 5,
      },
      {
        id: 'cns-sci',
    ...
    requirements: [
      {
        ...
        courses: ['Bi8', 'Bi9', 'BE25', 'Ch41a', 'ChBi110a'],
        minCourses: 4,
      },
      {
        id: 'be-core',
      ...
      },
      {
        ...
        courses: ['Bi114', 'Bi117', 'Bi122', 'Bi145', 'NBBiCNS150', 'EE111', 'EE112', 'APh9', 'MS125', 'MS133'],
        minUnits: 36,
      },
    ],
  },
  ...
  // ─── CS Minor ────────────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['CS115', 'CS116', 'CS124', 'CS128', 'CS130', 'CS131', 'CS132', 'CS152', 'CS151', 'CMS_CS_IDS139'],
        minUnits: 9,
      },
    ],
  },
  ...
  // ─── IDS Minor ───────────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['ACM104', 'ACM116', 'CMS_CS_CNS_EE_IDS155', 'CS_CNS_EE156a', 'IDS110', 'EE111', 'EECSIDs160'],
        minCourses: 4,
      },
      {
        id: 'idsm-elec',
        ...
        courses: ['IDS130', 'IDS162', 'CS_CNS_EE156b', 'ACM106b', 'CS115', 'CS_IDS150a', 'IDS101'],
        minUnits: 9,
      },
    ],
  },
  ...
  // ─── Aerospace Minor ─────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['AeAPh101a', 'AeAPh101b', 'AeAPh101c', 'AeAM102a', 'AeAM102b', 'AeAM102c', 'Ae103a', 'Ae103b', 'Ae103c', 'Ae104a', 'Ae104b', 'Ae121a', 'Ae121b'],
        minUnits: 27,
      },
    ],
  },
  ...
  // ─── Robotics Minor ──────────────────────────────────────────────
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['ME129', 'MECSEE133a', 'MECSEE133b', 'MECSEE134', 'MECSEE169'],
        minCourses: 4,
      },
      {
        id: 'rom-controls',
      ...
      },
      {
        ...
        courses: ['CMS_CS_CNS_EE_IDS155', 'EECNSS148a', 'CS_CNS_EE156a'],
        minCourses: 1,
      },
    ],
  },
    ...
    requirements: [
      {
        ...
        courses: ['AeAM102a', 'AeAM102b', 'AeAM102c', 'AeAPh101a', 'AeAPh101b', 'AeAPh101c'],
        minUnits: 54,
      },
    ],
  },
