  ...
  },
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        description: '9+ units of chemistry lab: Ch 3a or Ch 3x',
        courses: ['Ch3a', 'Ch3x'],
        minUnits: 9,
      },
      {
        ...
        description: '27 units of Ch 102 or above',
        courses: ['Ch21a', 'Ch21b', 'Ch21c', 'Ch41a', 'Ch41b', 'Ch41c'],
        minUnits: 27,
      },
    ],
  },
    ...
    requirements: [
      {
        id: 'chem-core',
        name: 'ChE Core',
        description: 'ChE 63a, ChE 101, ChE 103',
        courses: ['ChE63a', 'ChE101', 'ChE103'],
        minCourses: 3,
      },
      {
        id: 'chem-adv',
        name: 'Advanced ChE Electives',
        description: '18+ units from ChE 63b, approved 100-level ChE courses',
        courses: ['ChE63b', 'ChE130', 'ChE132', 'ChE165'],
        minUnits: 18,
      },
    ],
  },
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        description: 'Two of: Ge 11b, Ge 11c, Ge 11d',
        courses: ['Ge11b', 'Ge11c'],
        minCourses: 2,
      },
      {
        id: 'gpsm-adv',
        name: 'Advanced GPS Electives',
  ...
  },
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        courses: ['Ma3', 'CS13', 'MaCS6a', 'Ma121a'],
        minCourses: 2,
      },
      {
        id: 'idsm-core',
        name: 'IDS Core',
        description: 'ACM/IDS 104; ACM/EE/IDS 116; CMS/CS/CNS/EE/IDS 155 or CS/CNS/EE 156a',
        courses: ['ACM104', 'ACM116', 'CMS_CS_CNS_EE_IDS155', 'CS_CNS_EE156a', 'IDS101', 'IDS110'],
        minCourses: 3,
      },
      {
        id: 'idsm-elec',
        name: 'IDS Electives',
        description: '18+ units from IDS 100-level, CS/CNS/EE 156ab, ACM 106b, CS 115',
        courses: ['IDS130', 'IDS162', 'CS_CNS_EE156b', 'ACM106b', 'CS115', 'CS_IDS150a'],
        minUnits: 18,
      },
    ],
  },
